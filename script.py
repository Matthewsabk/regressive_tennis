...
def twovar_regress(df, target, var1, var2):
    ...
    print(f"Score of modeled winnings based on {str.title(x1)} and {str.title(x2)}: {model_score}")
...
feature_group_1 = ['FirstServe', 'FirstServePointsWon','FirstServeReturnPointsWon', 'SecondServePointsWon', 'SecondServeReturnPointsWon', 'Aces']
feature_group_2 = ['BreakPointsConverted','BreakPointsFaced', 'BreakPointsOpportunities', 'BreakPointsSaved','DoubleFaults']
feature_group_3 = ['ReturnGamesPlayed', 'ReturnGamesWon', 'ReturnPointsWon','ServiceGamesPlayed', 'ServiceGamesWon']
feature_group_4 = ['Wins', 'Losses','Ranking']
...
multi_var_regress (tennis, 'Winnings', feature_group_3)
multi_var_regress (tennis, 'Winnings', feature_group_4)
...
selected_feature_group = ['FirstServeReturnPointsWon', 'SecondServePointsWon', 'SecondServeReturnPointsWon', 'BreakPointsSaved', 'ReturnGamesWon', 'ServiceGamesWon','Wins', 'Losses']
